    ...
    def initialize(self):
        ...
        LINK_TABLE = [
            ...
            (0,  2,  'p2p', '100Mbps',  '1.60ms',
             10000,        0.0),  # Hiroshima–Dojima
            (1,  2,  'p2p', '100Mbps',  '0.25ms',
             10000,        0.0),  # Sakyo–Dojima
            (1,  3,  'p2p', '100Mbps',  '0.20ms',
             10000,        0.0),  # Sakyo–Nara

            (2,  3,  'p2p', '10Gbps',   '0.20ms',
             10000,        0.0),  # Dojima–Nara
            (2,  4,  'p2p', '100Gbps',  '1.30ms',
             10000,        0.0),  # Dojima–Komatsu
            (2,  5,  'p2p', '100Gbps',  '2.20ms',
             10000,        0.0),  # Dojima–Fujisawa
            (2,  9,  'p2p', '10Gbps',   '2.50ms',
             10000,        0.0),  # Dojima–Tsukuba

            (3,  5,  'p2p', '10Gbps',   '2.25ms',
             10000,        0.0),  # Nara–Fujisawa
            (3, 12,  'p2p', '10Gbps',   '2.25ms',
             10000,        0.0),  # Nara–KDDI Otemachi

            (4,  5,  'p2p', '100Gbps',  '1.75ms',
             10000,        0.0),  # Komatsu–Fujisawa

            (5,  6,  'p2p', '10Gbps',   '0.10ms',
             10000,        0.0),  # Fujisawa–Hiyoshi
            (5,  7,  'p2p', '150Gbps',  '0.12ms',
             10000,        0.0),  # Fujisawa–Yagami
            (5, 10,  'p2p', '10Gbps',   '0.30ms',
             10000,        0.0),  # Fujisawa–Akihabara
            (5, 12,  'p2p', '10Gbps',   '0.275ms',
             10000,        0.0),  # Fujisawa–KDDI Otemachi

            (7,  8,  'p2p', '150Gbps',  '0.175ms',
             10000,        0.0),  # Yagami–Nezu
            (7,  9,  'p2p', '10Gbps',   '0.50ms',
             10000,        0.0),  # Yagami–Tsukuba

            (9, 10,  'p2p', '100Gbps',  '0.275ms',
             10000,        0.0),  # Tsukuba–Akihabara

            (10, 11, 'p2p', '10Gbps',   '0.02ms',
             10000,        0.0),  # Akihabara–NTT Otemachi
            (10, 12, 'p2p', '100Gbps',  '0.02ms',
             10000,        0.0),  # Akihabara–KDDI Otemachi
        ]
